...
//Lambda Expression...
    ...
    public static void minSayiUInteger(List<Integer> sayi) {
    ...
    public static void minbulMath(List<Integer> sayi) {
        Optional<Integer> minsayi = sayi.
                stream().
                reduce(Math::min);
        System.out.println(minsayi);
    ...
    public static void minbulLampdaEx(List<Integer> sayi) {
    ...
    public static void minbulHalukca(List<Integer> sayi){
       Optional<Integer> minSayiHaluk=sayi.stream().reduce(Lambda02::byHalukmin);
        System.out.println(minSayiHaluk);
    }
    public static int byHalukmin(int a,int b){ // met hod kendisine verilen iki int degerin en kucugunu verir.
        return a<b?a:b;
    }

    // Task : List'teki 5'ten buyuk en kucuk tek sayiyi print ediniz.
    public static void BestenBuyukTekSayi(List<Integer>sayi){
    ...
    public static void ciftKareKbPrint(List<Integer>sayi){
        sayi.
                ...
                map(t->t*t).// filtrelenen cift sayilarin karesi alindi
    ...
    public static void tekKareBkPrint(List<Integer>sayi) {
        sayi.
                ...
                map(t -> t * t).// filtrelenen cift sayilarin karesi alindi
                sorted(Comparator.reverseOrder()). // karesi alinan elemanlar ters (b->k) siralandi
                forEach(Lambda01::yazdir); // print edildi.
