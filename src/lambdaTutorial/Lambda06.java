...
public class Lambda06 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Files.
                lines(Paths.
                        get("src/lambdaTutorial/haluk.txt")).
                // Files Class'dan lines() method call edilerek
                // data cekilecek dosya yolu (path)
                // parametre girilerek path'deki dosyanın datalari akisa alindi.
                        forEach(System.out::println);
                //akistaki datalar (her satirdaki String) yazildi.
        ...
        Files.
                ...
                //akistaki datalar buyuk harfe donusturuldu
                        forEach(System.out::println);
                //akistaki datalar (her satirdaki String) yazildi.
